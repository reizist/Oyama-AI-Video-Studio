...
export function buildAnima(prompt: string, negativePrompt: string, width: number, height: number, seed: number, unetName: string, clipName: string, vaeName: string, steps: number, cfg: number, samplerName: string, scheduler: string): ComfyPrompt {
  return {
