...
export function buildCheckpointImage(prompt: string, negativePrompt: string, width: number, height: number, seed: number, checkpoint: string, steps: number, cfg: number, samplerName: string, scheduler: string, clipSkip = 1): ComfyPrompt {
  return {
