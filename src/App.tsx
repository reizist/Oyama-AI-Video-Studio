  ...
  return (
    <div className={`app-shell ${sidebarOpen ? '' : 'sidebar-collapsed'}`}>
      ...
      <main className="main-area">
        ...
        {view === 'library' && <LibraryView onDelete={deleteGeneration} jobs={jobs.filter((job) => job.status === 'completed')} settings={settings} onEdit={() => setView('editor')} onUseLtx={loadStartFrameInLtx} onNotice={(tone, text) => setNotice({ tone, text })} />}
